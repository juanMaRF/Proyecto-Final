...
void mcu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<mcu *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->move(); break;
        case 1: _t->borra(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject mcu::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_mcu.data,
    qt_meta_data_mcu,
    qt_static_metacall,
    nullptr,
    nullptr
